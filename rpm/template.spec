...
Name:           ros-rolling-canopen-ros2-control
Version:        0.2.0
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS canopen_ros2_control package

License:        Apache-2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-rolling-canopen-402-driver
Requires:       ros-rolling-canopen-core
Requires:       ros-rolling-canopen-fake-slaves
Requires:       ros-rolling-canopen-proxy-driver
Requires:       ros-rolling-canopen-ros2-controllers
Requires:       ros-rolling-canopen-tests
...
BuildRequires:  ros-rolling-canopen-402-driver
BuildRequires:  ros-rolling-canopen-core
BuildRequires:  ros-rolling-canopen-proxy-driver
...
%changelog
* Tue Jun 20 2023 Lovro Ivanov <lovro.ivanov@gmail.com> - 0.2.0-1
